                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Principal.this, "Datos descargados", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                            startActivity(inLanzarInicio);
                        } else {
                            progressDialog.dismiss();
                            Toast.makeText(Principal.this, "Usuario y/o contraseña invalido", Toast.LENGTH_SHORT).show();
    ...
    public void perfil(View v){
        ...
        mensaseListaElementos.setItems(perfiles, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which){
                    case 0:
                        edtxt_usuario.setText("antoniohern.13@gmail.com");
                        edtxt_pass.setText("1593714");
                        ...
                        break;
                    case 1:
                        edtxt_usuario.setText("karla@gmail.com");
                        edtxt_pass.setText("123456");
                        editor.putInt("CLAVE",0);
                        ...
                        break;
                    case 2:
                        edtxt_usuario.setText("arturo@gmail.com");
                        edtxt_pass.setText("12345678");
                        ...
                        break;
                    case 3:
                        edtxt_usuario.setText("edgar@gmail.com");
                        edtxt_pass.setText("582369");
